...
All environment variables should start with "URL_SCANNER_" prefix.

For example if you see in your "url_scanner/settings.py" a variable named like
`random_parameter`, you should provide the "URL_SCANNER_RANDOM_PARAMETER" 
variable to configure the value. This behaviour can be changed by overriding `env_prefix` property
in `url_scanner.settings.Settings.Config`.
