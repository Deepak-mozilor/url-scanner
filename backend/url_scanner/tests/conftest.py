...
from url_scanner.db.utils import create_database, drop_database
from url_scanner.settings import settings
from url_scanner.web.application import get_app
...
async def _engine(anyio_backend: Any) -> AsyncGenerator[AsyncEngine]:
    ...
    from url_scanner.db.models import load_all_models
